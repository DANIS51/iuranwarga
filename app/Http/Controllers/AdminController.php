...
class AdminController extends Controller
{
    ...
    public function users()
    {
        ...
        $users = User::select('id', 'name', 'email', 'level as role')
    ...
    {
        // Ambil data iuran langsung dari database
    ...
    {
        // Ambil data pembayaran langsung dari database
    ...
    {
        // Ambil data laporan langsung dari database
